...
namespace SudokuGame
{
    ...
    public partial class Easy : ContentPage
    {
        ...
        void NumSelected1(object sender, EventArgs e)
        {
            ...
            NumSelectEasy.Text = "Number selected: " + numChoice;
        ...
        public void CommandButtonClick(string a)//Command
        {
            if(pencil == false && numChoice != '0')
            {
                ...
                else { valid = false; ErrorCounterEasy.Text = "Errors: " + ++countError; }
            }
        }//end of Command
        ...
        //board solution
        string[] solution = new string[9] {"856917423",
                                           "213864597",
                                           "947235816",
                                           "185396742",
                                           "762148359",
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                TimerCounterEasy.Text = elapsed.ToString(@"hh\:mm\:ss");
            });
        }
    }
}